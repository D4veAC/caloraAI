...
export function calculateNutritionTargets(profile = {}, now = new Date()) {
...
export function aggregateDailyNutrition(entries = [], date = new Date()) {
...
export function calculateDailyNutritionState(entries = [], targets, date = new Date()) {
...
export function calculateNextMealConstraints(state, profile = {}, now = new Date()) {
...
export function recommendNextMeal(state, profile = {}, recentMeals = [], now = new Date()) {
